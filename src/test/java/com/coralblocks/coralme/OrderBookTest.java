...
public class OrderBookTest {
    ...
    public void test_a_Bunch() {
    	...
    	for(int i = 0; i < 2; i++) {
	        ...
	        ob.createLimit(100001L, "b77908b5-9755-45c3-bb73-dc3884e8c8a2", 3340L, Side.SELL, 8L, 8100000000L, TimeInForce.GTC);
	        ob.createLimit(100003L, "15584205-ef97-456b-8101-3fab653d46cd", 3344L, Side.BUY, 6L, 6375000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "c39b9e5e-cf8f-4b17-8fb0-b010f6fa5ed6", 3349L, Side.SELL, 2L, 6025000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "582436c0-85ac-4916-a6ca-eaefda0a13fd", 3362L, Side.BUY, 8L, 5750000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "38730fd6-31cd-4227-a11c-2a81a6a8329c", 3368L, Side.BUY, 6L, 6200000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "5169becf-d00d-4e8c-a43d-63e6b88e0041", 3374L, Side.BUY, 6L, 7375000000L, TimeInForce.GTC);
	        ob.createLimit(100003L, "8ae685fd-4b92-4e55-ba80-6c2f4993f8fb", 3403L, Side.BUY, 2L, 7375000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "4ec7ff72-a2d7-44c4-8f3d-17931bf20ccc", 3408L, Side.BUY, 8L, 7325000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "bde2d09e-ec34-407c-b2ca-54c5f2bd69de", 3414L, Side.BUY, 4L, 7675000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "c00fcad5-8f7c-4874-87c8-4e3fa46849e1", 3421L, Side.SELL, 8L, 5750000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "5f708f6e-317b-40d4-847a-019ca2aa5eb9", 3456L, Side.BUY, 8L, 6650000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "ead84eb6-5797-4f9e-881f-6381bc549463", 3462L, Side.SELL, 6L, 8075000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "e2b9d90a-4c00-4a53-bc6d-7106e40d47f7", 3468L, Side.BUY, 1L, 6925000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "0258feb0-ca86-4931-9db9-3170fce19476", 3474L, Side.BUY, 9L, 8125000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "806905a5-667e-4ffe-8c30-3ad7427cc35b", 3492L, Side.SELL, 4L, 7575000000L, TimeInForce.GTC);
	        ob.createLimit(100003L, "6fbb880e-4459-4a72-9309-b164038027c0", 3501L, Side.SELL, 9L, 8475000000L, TimeInForce.GTC);
	        ob.createLimit(100003L, "79ba077b-d3c1-41ec-b9a6-a07b65b628fd", 3507L, Side.SELL, 6L, 7675000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "fc3d8565-3a9d-4dc5-bd3f-d8606e714c14", 3513L, Side.BUY, 1L, 8350000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "1fb88851-c533-471e-bd2d-e458a5575355", 3529L, Side.BUY, 7L, 8500000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "18a726a2-a3f9-4a2f-a6c2-c757cca84861", 3559L, Side.BUY, 7L, 5775000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "54a5bf66-8b03-47c9-b63c-16fd71ef9191", 3565L, Side.BUY, 4L, 7875000000L, TimeInForce.GTC);
	        ob.createLimit(100003L, "9d1ba622-c807-4444-a5df-fb2a8def7ac4", 3592L, Side.SELL, 6L, 7875000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "cd1da357-b81a-4fc8-9155-289eceebc1da", 3598L, Side.BUY, 5L, 6625000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "c1dad4df-ac54-401f-828f-ff1e2fad5bf5", 3604L, Side.BUY, 8L, 6250000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "407d6048-d630-40c7-8c5b-9586a22abe71", 3610L, Side.SELL, 1L, 5750000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "cc1f83d2-a105-45e8-b153-6ff6e6baae86", 3626L, Side.BUY, 2L, 6575000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "1cff336d-6d96-4526-98fe-545d5fc3d6db", 3632L, Side.BUY, 3L, 6900000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "2605357d-91d1-466a-8380-261d79edd8a8", 3638L, Side.SELL, 5L, 7700000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "6d13138d-556e-4f4c-8463-26b486139dc2", 3645L, Side.BUY, 9L, 7975000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "24f0b927-a741-4ccd-9d0f-b4f812e363e5", 3672L, Side.SELL, 9L, 6775000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "dacc367f-8d38-4f8b-b5cc-ab6cb6807698", 3705L, Side.BUY, 1L, 7875000000L, TimeInForce.GTC);
	        ob.createLimit(100003L, "3f656fcd-eb2a-4f2f-8e78-8a8a7b565898", 3721L, Side.SELL, 2L, 6450000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "38228db4-3949-4507-b5e6-99b505950e0a", 3922L, Side.BUY, 7L, 8500000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "f5fa9107-f845-49a2-951c-ae4c46fce41f", 3946L, Side.SELL, 2L, 8475000000L, TimeInForce.GTC);
	        ob.createLimit(100003L, "fda99662-5992-4aec-aaad-884cd4df460f", 3952L, Side.BUY, 8L, 6325000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "880c4d59-9c4e-455e-baf0-052f2820bd9f", 3960L, Side.BUY, 4L, 5950000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "b79a784e-385e-44be-a4a9-91a8b07312ba", 3966L, Side.SELL, 3L, 6375000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "a66a5b1d-0f81-47a5-816c-350b13896df2", 3987L, Side.SELL, 5L, 7025000000L, TimeInForce.GTC);
	        ob.createLimit(100003L, "fbfef7a8-b0e9-4077-afeb-ea96a85ec754", 3998L, Side.BUY, 5L, 7000000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "4d03fe2d-a824-4dea-98e8-5dadbb684d68", 4002L, Side.SELL, 1L, 7075000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "b67f6548-2b78-4b47-a248-5105be347a4f", 4018L, Side.SELL, 8L, 6550000000L, TimeInForce.GTC);
	        ob.createLimit(100000L, "f6337390-4a34-4d6e-a2f5-b45811070442", 4055L, Side.SELL, 2L, 6075000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "79183748-4649-47cd-a63c-d8313d46cd2a", 4073L, Side.SELL, 6L, 7000000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "83426aa6-c803-4f44-8736-24348cd7669e", 4078L, Side.BUY, 7L, 5775000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "cb6f9cf8-b8f9-4ad8-bbd4-72b575356ec3", 4084L, Side.BUY, 8L, 7500000000L, TimeInForce.GTC);
	        ob.createLimit(100002L, "1aa398d5-51a6-4a3b-98b6-01e2da16adef", 4099L, Side.BUY, 2L, 8325000000L, TimeInForce.GTC);
	        ob.createLimit(100003L, "4edd5153-0586-4d54-ae8e-2b3c03a3f11b", 4106L, Side.BUY, 6L, 7475000000L, TimeInForce.GTC);
	        ob.createLimit(100001L, "1214b245-6271-4263-b8f2-06ce9079ab37", 4110L, Side.SELL, 6L, 6875000000L, TimeInForce.GTC);
    	}
    }
}