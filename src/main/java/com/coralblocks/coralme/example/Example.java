...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Debug: Creating limit order - Side: "
                        + Side.BUY
                        + ", TimeInForce: "
                        + TimeInForce.DAY);
        ...
        */
        ...
        System.out.println(
                "Debug: Creating another limit order - Side: "
                        + Side.BUY
                        + ", TimeInForce: "
                        + TimeInForce.DAY);
        orderBook.createLimit(
        ...
        */
        ...
        // Buy 100 @ market
        System.out.println("Debug: Creating market order - Side: " + Side.BUY);
